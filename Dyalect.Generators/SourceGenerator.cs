...
namespace Dyalect.Generators
{
    public abstract class SourceGenerator : ISourceGenerator
    {
        internal static class Types
        {
            ...
            public const string MethodAttribute = "Dyalect.Runtime.Codegen.MethodAttribute";
            public const string StaticMethodAttribute = "Dyalect.Runtime.Codegen.StaticMethodAttribute";
            public const string InstanceMethodAttribute = "Dyalect.Runtime.Codegen.InstanceMethodAttribute";
            public const string InstancePropertyAttribute = "Dyalect.Runtime.Codegen.InstancePropertyAttribute";
            public const string StaticPropertyAttribute = "Dyalect.Runtime.Codegen.StaticPropertyAttribute";
        }
        ...
        protected void Error(GeneratorExecutionContext ctx, string text) =>
