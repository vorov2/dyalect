# 0.29.0
  ...
  * Change: _A bug fixed in Dyalect console in processing of boolean command line switches._
...
# 0.27.0
  ...
  * Fix: _Inconsistent run-time error message_ ([Issue #540](https://github.com/vorov2/dyalect/issues/540)).
...
# 0.26.0
  ...
  * Add: _Add `Iterator.contains` method_ ([Issue #510](https://github.com/vorov2/dyalect/issues/510), [docs](https://github.com/vorov2/dyalect/wiki/Iterator#contains)).
  * Add: _Add `in` operator_ ([Issue #501](https://github.com/vorov2/dyalect/issues/501), [docs](https://github.com/vorov2/dyalect/wiki/Standard-operators#in)).
  * Add: _Mutable fields for custom type with autogenerated constructors_ ([Issue #500](https://github.com/vorov2/dyalect/issues/500), [docs](https://github.com/vorov2/dyalect/wiki/Custom-types#anno)).
...
# 0.25.0
  ...
  * Add: _Map: add method `compact(by)`_ ([Issue #393](https://github.com/vorov2/dyalect/issues/393), [docs](https://github.com/vorov2/dyalect/wiki/Dictionary#compact)).
  ...
  * Add: _Add `Map.toTuple` method_ ([Issue #482](https://github.com/vorov2/dyalect/issues/482), [docs](https://github.com/vorov2/dyalect/wiki/Dictionary#toTuple)).
...
# 0.17.4
  ...
  * Fixed: _Custom type: autogenerated and regular ctors at the same time_ ([Issue #386](https://github.com/vorov2/dyalect/issues/386)).
...
# 0.11.0
  ...
  * Done: _Implement `Map` data type_ ([Issue #235](https://github.com/vorov2/dyalect/issues/235), [docs](https://github.com/vorov2/dyalect/wiki/Dictionary)).
