# 0.26.0
  ...
  * Add: _Mutable fields for custom type with autogenerated constructors_ ([Issue #500](https://github.com/vorov2/dyalect/issues/500), [docs](https://github.com/vorov2/dyalect/wiki/Custom-types)).
