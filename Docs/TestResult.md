# Test session from 17/04/2022 19:35

## Summary:
722 passed, 2 failed in 28 file(s)
...
* &#9746; **Calendar: FirstDayOfMonth**: An unhandled exception occured during an execution of an external function "assert": The UTC Offset of the local dateTime parameter does not match the offset argument. (Parameter 'offset')
* &#9746; **Calendar: LastDayOfMonth**: An unhandled exception occured during an execution of an external function "assert": The UTC Offset of the local dateTime parameter does not match the offset argument. (Parameter 'offset')
