...
//        internal DyError(string errorName, params object[] dataItems) : 
//            this(errorName, DyErrorCode.UnexpectedError, dataItems) { }

//        internal DyError(string errorName, DyErrorCode code, params object[] dataItems) : base(DyType.Error) =>
//            (this.errorName, Code, DataItems) = (errorName, code, dataItems);
