    ...
    internal sealed class DyIteratorTypeInfo : DyTypeInfo
    {
        ...
        protected override DyFunction? InitializeInstanceMember(DyObject self, string name, ExecutionContext ctx) =>
            name switch
            {
                ...
                Method.ToDictionary => Func.Member(name, ToMap, -1, new Par("key"), new Par("value", DyNil.Instance)),
                ...
                Method.Slice => Func.Member(name, GetSlice, -1, new Par("from", DyInteger.Zero), new Par("to", DyNil.Instance)),
                Method.Element => Func.Member(name, ElementAt, -1, new Par("at")),
                Method.Sort => Func.Member(name, SortBy, -1, new Par("by", DyNil.Instance)),
                Method.Shuffle => Func.Member(name, Shuffle),
                Method.Count => Func.Member(name, CountBy, -1, new Par("by")),
                Method.Map => Func.Member(name, Map, -1, new Par("transform")),
                ...
                Method.Reduce => Func.Member(name, Reduce, -1, new Par("init", DyInteger.Zero), new Par("by")),
        ...
        protected override DyFunction? InitializeStaticMember(string name, ExecutionContext ctx) =>
            name switch
            {
                ...
                Method.Range => Func.Static(name, MakeRange, -1, new Par("from", DyInteger.Zero), new Par("to", DyNil.Instance),
