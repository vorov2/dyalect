...
namespace Dyalect.Parser
{
	...
	void FunctionStatement(out DNode node) {
		node = null; 
		switch (la.kind) {
		case 9: case 10: case 11: case 80: case 81: {
			Binding(out node);
			if (la.kind == 71) {
				Guard(node, out node);
			}
		...
		case 1: case 3: case 4: case 5: case 6: case 7: case 8: case 14: case 23: case 29: case 31: case 33: case 46: case 47: case 48: case 65: case 73: case 74: case 83: case 85: case 86: case 90: case 91: case 96: case 98: case 99: {
			Assignment(out node);
			if (la.kind == 71) {
				Guard(node, out node);
			}
	...
	void Lambda(out DNode node) {
		...
		functions.Push(f); 
		Expect(23);
		SimpleExpr(out var exp);
		f.Body = exp; functions.Pop(); 
	}

	void NoArgLambda(out DNode node) {
		var f = new DFunctionDeclaration(t);
		node = f;
