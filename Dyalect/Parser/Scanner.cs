...
namespace Dyalect.Parser
{
	...
	const int noSym = 85;
		...
		for (int i = 49; i <= 57; ++i) start[i] = 50;
		start[95] = 51; 
		start[35] = 2; 
		start[48] = 52; 
		start[46] = 73; 
	...
	bool Comment1() {
		...
		switch (t.val) {
			...
			case "when": t.kind = 66; break;
			case "static": t.kind = 67; break;
			case "auto": t.kind = 68; break;
			case "private": t.kind = 69; break;
			...
			case "try": t.kind = 81; break;
			case "catch": t.kind = 82; break;
		...
		if (ch == '/' && Comment0() ||ch == '/' && Comment1()) return NextToken();
			...
			case 2:
				...
				else if (ch == '_') {AddCh(); goto case 55;}
				else {goto case 0;}
			case 3:
			...
			case 57:
				if (ch <= 9 || ch >= 11 && ch <= 12 || ch >= 14 && ch <= '!' || ch >= '#' && ch <= '[' || ch >= ']' && ch <= 65535) {AddCh(); goto case 57;}
