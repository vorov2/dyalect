...
namespace Dyalect.Parser
{
	...
	bool Comment1() {
		...
		switch (t.val) {
			...
			case "when": t.kind = 52; break;
			case "else": t.kind = 53; break;
			case "static": t.kind = 54; break;
			case "auto": t.kind = 55; break;
			case "private": t.kind = 56; break;
			case "match": t.kind = 58; break;
			case "nil": t.kind = 63; break;
		...
		if (ch == '/' && Comment0() ||ch == '/' && Comment1()) return NextToken();
			...
			case 2:
				...
				else if (ch == '_') {AddCh(); goto case 41;}
				else {goto case 0;}
			case 3:
			...
			case 21:
				...
				else if (ch == 39) {AddCh(); goto case 22;}
			...
			case 25:
				if (ch <= 92 || ch >= '^' && ch <= 65535) {AddCh(); goto case 25;}
			...
			case 44:
				...
				else if (ch == 39) {AddCh(); goto case 49;}
				else {goto case 0;}
			case 45:
