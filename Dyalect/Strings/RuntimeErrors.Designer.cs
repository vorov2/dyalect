...
namespace Dyalect.Strings {
    ...
    internal class RuntimeErrors {
        ...
        /// <summary>
        ///   Looks up a localized string similar to An attempted operation is invalid in the current context..
        /// </summary>
        internal static string InvalidOperation_0 {
            get {
                return ResourceManager.GetString("InvalidOperation.0", resourceCulture);
            }
        }
        ...
        /// <summary>
        ///   Looks up a localized string similar to Cannot complete an IO operation..
        /// </summary>
        internal static string IOFailed_0 {
            get {
                return ResourceManager.GetString("IOFailed.0", resourceCulture);
            }
        }
